...
class InternshipInfo extends Component {
    ...
    handleAddInternshipBlock = (event) => {
        let tid = Date.now();
        let newBlock = {id:tid, organizationName:'', description:'', supervisor:'', start:'', end:'', teamSize:''};
    ...
    handleChangeOrganizationName = (event, id) => {
        ...
        let dummyBlock = {id:'dummy', organizationName:'', description:'', supervisor:'', start:'', end:'', teamSize:''};
    ...
    render() {
        return (
            <div>
                                ...
                                <Card.Body>
                                    <Form>
                                        <Form.Group controlId="formGroupOrganizationName">
                                            ...
                                            <Form.Control type="text" placeholder="Microsoft/DA-IICT" onChange={(event) => {this.handleChangeOrganizationName(event,value.id)}} />
                                        </Form.Group>

                                        <Form.Group controlId="formGroupDescription">
                                            <Form.Label>Description</Form.Label>
                                            <Form.Control as="textarea" row="2" placeholder="Description about internship..." onChange={(event) => {this.handleChangeDescription(event,value.id)}} />
                                        </Form.Group>

                                        <Form.Group controlId="formGroupScore">
                                            <Form.Label>Guide/Supervisor</Form.Label>
                                            <Form.Control type="text" placeholder="Prof./Mr./Mrs./Ms. X" onChange={(event) => {this.handleChangeSupervisor (event,value.id)}} />
                                        </Form.Group>
                                    ...
                                    onClick={() => {this.handleRemoveInternshipBlock(value.id)}}
                ...
                <Button variant="primary" onClick={this.handleAddInternshipBlock}> +Add </Button>
            </div>
        )
    }
}
...
const mapDispatchToProps = (dispatch) => {
    return {
        addInternshipBlock: (newBlock) => { dispatch({type:'ADD_INTERNSHIP_BLOCK', newBlock: newBlock}) },
        updateOrganiztionName: (organizationName,id) => { dispatch({type: 'UPDATE_INTERNSHIP_ORGANIZATION_NAME', organizationName: organizationName, id:id}) },
        updateDescription: (description,id) => { dispatch({type: 'UPDATE_INTERNSHIP_DESCRIPTION', description: description, id:id }) },
        updateSupervisor: (supervisor,id) => { dispatch({type: 'UPDATE_INTERNSHIP_SUPERVISOR', supervisor: supervisor, id:id}) },
        updateStart: (start,id) => { dispatch({type: 'UPDATE_INTERNSHIP_START', start: start, id:id}) },
        updateEnd: (end,id) => { dispatch({type:'UPDATE_INTERNSHIP_END', end: end, id:id}) },
        updateTeamSize: (teamSize,id) => { dispatch({type:'UPDATE_INTERNSHIP_TEAM_SIZE', teamSize: teamSize, id:id}) },
        removeInternshipBlock: (id) => { dispatch({type: 'REMOVE_INTERNSHIP_BLOCK', id:id}) }
    }
}
