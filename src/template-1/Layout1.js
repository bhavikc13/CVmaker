        ...
        for(let[index,value] of this.props.degreeBlocks.entries())
        {
            newDegreeBlocks.push(
                <tr key={index}>
                    ...
                    <td style={{textAlign: "left", padding: '10px 0px 10px 10px'}}> {value.instituteName} </td>
                    <td style={{textAlign: "left", padding: '10px 10px 10px 5px'}}> {value.year} </td>
                    <td style={{textAlign: "left", padding: '10px 5px 10px 10px'}}> {value.score} </td>
                </tr>
            )
        }
    ...
    updateInternshipBlock = () => {
        ...
        for(let[index,value] of this.props.internshipBlocks.entries())
        {
            newInternshipBlocks.push(
                <tr key={index}>
                    <td className="w-20" style={{textAlignVertical: 'top', textAlign: 'left'}}>
                        <p>
                    ...
                    <td className="w-60" style={{textAlignVertical: 'top'}}>
                        <p>
                            ...
                            <p style={{textAlign: 'left'}}>
                                <i><b>Guide:</b> {value.supervisor}</i>
                            </p>
                        </p>
                    </td>
                    <td className="w-20" style={{textAlignVertical: 'top', textAlign:'right'}}>
    ...
    updateProjectBlock = () => {
        ...
        for(let[index,value] of this.props.projectBlocks.entries())
        {
            newProjectBlocks.push(
                <tr key={index}>
                    <td className="w-80" style={{textAlignVertical: 'top', textAlign: 'left'}}>
                        <p>
